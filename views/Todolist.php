...
<form action="/todos/insert" method="POST" id="task"> 
    <div class="panel panel-default allcontent">
        <div class="panel-heading color_login"><h3>Add Todo</h3> </div>
        <div class="form-group">
            <label for="usr">Name:</label>
            <input type="text" class="form-control" id="usrins" name="name" >
        </div>

        <div class="form-group">
            <label for="email">Email:</label>
            <input type="text" class="form-control" id="emailins" name="email">
        </div>
        <div class="form-group">
            <label for="task">Task:</label>
            <textarea class="form-control task" id="taskins" name="task"></textarea>
        </div>
...
<div class="container">
    ...
    <div class="pagination">
        ...
        for ($j = 1; $j < $count + 1; $j++) {
            if ($j == $page) {
                echo "<a class='active' href='/todos/page/" . $j . "'>" . $j . "</a>";
            } else {
                echo "<a href='/todos/page/" . $j . "'>" . $j . "</a>";
            }
        }
